...
contract DeployCrowdfunding is Script {
    ...
    uint256 private constant MINIMUM_USD_CONTRIBUTION = 50e18;

    /// @notice Funding target expressed in USD with 18 decimals.
    uint256 private constant FUNDING_TARGET_USD = 1_000e18;

    /// @notice Campaign duration expressed in seconds for a 5-day campaign.
    uint256 private constant CAMPAIGN_DURATION = 5 days;
